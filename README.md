# Информация об этом календаре является подозрительной. Я не несу никакой ответсвенности за ее распространение и применение. Мне было интересно решить задачу и получить что-то полезное взамен.
